...
(let ((class '((class color) (min-colors 89)))
      ...
      (white-1 "#f5f5f5") (white-2 "#c6c6c6") (white-3 "#b2b2b2") (black-1 "#a8a8a8") (black-2 "#8a8a8a")
      (black-2-5 "#6c6c6c") (black-3 "#4e4e4e") (black-4 "#121212") (black-5 "#232323") (black-6 "#000000")
  ...
  (defconst -moe-dark-comment-delimiter          grey-0)
  (defconst -moe-dark-comment                    grey-0)
  ...
  (custom-theme-set-faces
   ...
   `(font-lock-keyword-face              ((,class (:background unspecified :foreground ,moe-dark-keyword      :weight bold))))
   ...
   `(line-number-current-line ((,class (:background ,black-4 :foreground ,white-0))))
   `(highlight ((,class (:background ,black-2 :foreground ,yellow-3))))
   `(hl-line ((,class (:background ,black-6))))
   `(highlight-symbol-face ((,class (:background ,green-5))))
   `(region ((,class (:background ,black-2-5))))
   ...
   `(org-tag ((,class (:background ,black-4 :foreground ,white-1 :bold t :weight bold))))
