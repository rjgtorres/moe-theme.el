...
;; Monokai
;; ======================================================
(defun moe-theme-flavour-darkmate ()
  (interactive)
  (let ((dmgray     "#bbbbbb")
	(dmwhite    "#eeeeee")
	(dmyellow   "#fce94f")
	...
	(dmasfalto  "#555753")
	(dmcarbon   "#232323"))
    (setq moe-dark-bg dmcarbon)
    (setq moe-dark-fg dmwhite)
    (setq moe-dark-builtin dmyellow)
    (setq moe-dark-comment-delimiter dmpurple)
    (setq moe-dark-comment dmpurple)
    (setq moe-dark-constant dmyellow)
    (setq moe-dark-doc dmviolet)
    (setq moe-dark-doc-string dmviolet)
    (setq moe-dark-function-name dmred)
    (setq moe-dark-keyword dmambra)
    (setq moe-dark-negation-char dmfuchsia)
    (setq moe-dark-preprocessor dmaqua)
    (setq moe-dark-regexp-grouping-construct dmalga)
    (setq moe-dark-regexp-grouping-backslash dmmagenta)
    (setq moe-dark-string dmalga)
    (setq moe-dark-type dmcyan)
    (setq moe-dark-variable-name dmskin)
    (setq moe-dark-warning dmred)
    (moe-dark)))
...
(defun moe-theme-flavour-lightmate ()
  ...
  (let ((lmgray     "#bbbbbb")
	...
	(lmcarbon   "#232323")
        (lmblack    "#000000"))
    (setq moe-light-bg lmwhite)
    (setq moe-light-fg lmblack)
    (setq moe-light-builtin lmred)
    (setq moe-light-comment-delimiter lmskin)
    (setq moe-light-comment lmgray)
    (setq moe-light-constant lmred)
    (setq moe-light-doc lmviolet)
    (setq moe-light-doc-string lmviolet)
    (setq moe-light-function-name lmfuchsia)
    (setq moe-light-keyword lmambra)
    (setq moe-light-negation-char lmfuchsia)
    (setq moe-light-preprocessor lmasfalto)
    (setq moe-light-regexp-grouping-construct lmalga)
    (setq moe-light-regexp-grouping-backslash lmmagenta)
    (setq moe-light-string lmalga)
    (setq moe-light-type lmcyan)
    (setq moe-light-variable-name lmorange)
    (setq moe-light-warning lmmagenta)
    (moe-light)))
